...
var handleDashboardOrganizationAdminSparkline = function() {
	"use strict";
    var options = {
        height: '50px',
        width: '100%',
    ...
    function renderDashboardOrganizationAdminSparkline() {
    ...
    renderDashboardOrganizationAdminSparkline();
...
var DashboardOrganizationAdmin = function () {
	"use strict";
    return {
        //main function
        init: function () {
            ...
            $.getScript('assets/plugins/sparkline/jquery.sparkline.js').done(function() {
                handleDashboardOrganizationAdminSparkline();
            });
